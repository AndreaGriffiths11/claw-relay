...
3. Agent connects using your Mac's Tailscale IP:

```
ws://your-mac.tailnet:19222?role=agent&token=YOUR_TOKEN
```
...
- **Local only by default** — WebSocket runs on localhost; use Tailscale or a tunnel for remote agents
